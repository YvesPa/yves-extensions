...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Omegascan = exports.OmegascanInfo = exports.API_URL = exports.BASE_URL = void 0;
const types_1 = require("@paperback/types");
const OmegascanParser_1 = require("./OmegascanParser");
...
const OmegascanHelper_1 = require("./OmegascanHelper");
class Omegascan {
    constructor() {
        this.cheerio = cheerio;
        this.parser = new OmegascanParser_1.WebtoonParser();
    ...
    async getChapters(mangaId) {
        ...
        do {
            const result = await this.ExecApiRequest({
                url: `${exports.API_URL}/chapter/query`,
                param: this.paramsToString(params)
            }, (data) => this.parser.parseChaptersList(data, params.page));
    ...
    getCarouselTitles() {
        return this.ExecApiRequest({ url: `${exports.API_URL}/series/banners` }, this.parser.parseCarouselTitles);
    }
...
exports.convertIdSlugToMangaId = convertIdSlugToMangaId;
...
class WebtoonParser {
    ...
    parseChaptersList(data, pageNumber) {
    ...
    parseMangaFromCarouselElement(elem) {
        return App.createPartialSourceManga({
            mangaId: (0, OmegascanHelper_1.convertIdSlugToMangaId)(elem.series.id, elem.series.series_slug),
    ...
    parseSearchListItem(item) {
        return App.createPartialSourceManga({
            mangaId: (0, OmegascanHelper_1.convertIdSlugToMangaId)(item.id, item.series_slug),
            title: item.title,
